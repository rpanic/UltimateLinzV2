...
import main.AsciiTable.ColumnDefinition.Column;
...
public class AsciiTable <T> {
    ...
    public String renderAscii(){
        ...
        for (int i = 0 ; i < columns.columns.size() ; i++){
            ...
            header.append(" ").append(UtilsKt.padRight(column.columnname, paddings.get(i))).append(" |");
        ...
        for (List<String> d : data) {
            ...
            for(int i = 0 ; i < columns.columns.size() ; i++) {
                ...
                entries.append(" ").append(UtilsKt.padRight(d.get(i), paddings.get(i))).append(" |");
        ...
        for(int i = 0 ; i < columns.columns.size() ; i++){
            ...
            if(column.pk){
                ...
                summary.append(UtilsKt.padRight(data.size() + "", paddings.get(i))).append(" |");

            }else if(!column.infoColumn){

                summary.append(" ").append(UtilsKt.padRight(sums.get(column) + "", paddings.get(i))).append(" |");
